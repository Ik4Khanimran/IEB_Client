...
import { OPN_CHECKSHEET_AUDIT_URL } from '../../../utils/apiUrls';
import { AUDIT_REMARK_URL } from '../../../utils/apiUrls';
import { useLocation } from 'react-router-dom';
import '../../csspage/styles.css';

const Auditchecksheet = () => {
    ...
    const fetchData = useCallback(async () => {
        ...
        try {
            ...
            const response = await axios.post(OPN_CHECKSHEET_AUDIT_URL, {
                esn,
                stno,
            }, {
                headers: {
    ...
    useEffect(() => {
        if (resultData) {
            ...
            console.log('description:', headerData.bom_srno__description); // Log the engmodel
        }
    }, [resultData]);
    ...
    const handleFormSubmit = async (buttonValue) => { // Receive button value here
        ...
        const formData = {
            ...
            remark: remark,
            result: buttonValue // Add the button value here
        };
        if (!remark.trim()) {
                ...
                {error ? (
                    ...
                    <div>
                        <div className="row mt-2">
                            ...
                            <div className="col-lg-3 col-md-3 col-sm-3">
                                <div className="form-group">
                                    <label>Model: {resultData.header_data[0].bom_srno__description}</label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="row justify-content-center align-items-center mt-2">
                            <div className="col-lg-12 col-md-12 col-sm-12">
                                <div className="form-group">
                                    {resultData.rework_status ? (
                                        <p>Rework was done
                                        <hr className="hr2" style={{ padding: '0', marginTop: '10px', marginBottom: '0px' }} />  
                                        Auditor Previous Remark 
                                        <hr className="hr2" style={{ padding: '0', marginTop: '10px', marginBottom: '0px' }} />  
                                        <div className="row justify-content-center align-items-center mt-2">
                                            <div className="col-lg-4 col-md-4 col-sm-4">
                                                <div className="form-group">
                                        ...
                                        <div className="row justify-content-center align-items-center mt-2">
                                            <div className="col-lg-4 col-md-4 col-sm-4">
                                                <div className="form-group">
                                                    <label>Rework: {resultData.rework_comment[0].username}</label>
                                                </div>
                                            </div>
                                            <div className="col-lg-4 col-md-4 col-sm-4">
                                                <div className="form-group">
                                                    <label>Emp ID: {resultData.rework_comment[0].emp_id}</label>
                                                </div>
                                            </div>
                                            <div className="col-lg-4 col-md-4 col-sm-4">
                                                <div className="form-group">
                                                    <label>Timestamp: {resultData.rework_comment[0].timestamp}</label>
                                                </div>
                                            </div>
                                        </div>                        
                                        <div className="row justify-content-center align-items-center mt-2">
                                            <div className="col-lg-12 col-md-12 col-sm-12">
                                                <div className="form-group">
                                                    <label>Rework Remark: {resultData.rework_comment[0].remark}</label>
                                                </div>
                                            </div>
                                        </div>
                                        </p>                                        
                        ...
                        <div className="row justify-content-center align-items-center mt-2">
                            <div className="col-lg-12 col-md-12 col-sm-12">
                                <div className="form-group">
                                    <label htmlFor="comment">Auditor Comment:</label>
                                    <textarea
                                ...
                                <div className="row justify-content-center align-items-center mt-2">
                                    <div className="col-lg-12 col-md-12 col-sm-12 d-flex justify-content-center">
                                        <button
                                            ...
                                            onClick={() => handleFormSubmit('ReCheck')}
                                        >
                                            Pass
                                        </button>
                                    </div>
...
export default Auditchecksheet;
