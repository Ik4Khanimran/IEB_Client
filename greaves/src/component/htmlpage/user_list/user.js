  ...
  const handleEdit = (rowData) => {
    try {
      ...
      // Open the edit form with pre-filled data
          // Include dropdownValue and responseData in the query parameters
    const queryParams = new URLSearchParams({
      dropdownValue: dropdownValue,
      responseData: JSON.stringify(rowData), // Include only the selected row data as a query parameter
      csrfToken: csrfToken
    }).toString();
